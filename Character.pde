class Characters {
  ...
  void update(double dt) {
    ...
    if (keys['a'] == true) {
      ...
      if (currentGrid[yCord][xCord - 1] != 'b' && currentGrid[yCord][xCord - 1] != 'f' && posX - (sizeX / 2) < xCord * 35 + 2) {
        wallLeft = true;
      }
      
      else if (currentGrid[yCord - 1][xCord - 1] != 'b' && currentGrid[yCord - 1][xCord - 1] != 'f' && posX - (sizeX / 2) < xCord * 35 + 2 &&
    ...
    if (keys['d'] == true) {
      ...
      if (currentGrid[yCord][xCord + 1] != 'b' && currentGrid[yCord][xCord + 1] != 'f' && posX + (sizeX / 2) > xCord * 35 + 34) {
        wallRight = true;
        println(1);
      }
      
      else if (currentGrid[yCord - 1][xCord + 1] != 'b' && currentGrid[yCord - 1][xCord + 1] != 'f' && posX + (sizeX / 2) > xCord * 35 + 34 &&
      posY < walls[yCord - 1][xCord + 1].y + 35 + sizeY / 2) {
        wallRight = true;
        println(2);
      }
    ...
    if (keys['w'] == true) {
      ...
      if (currentGrid[yCord - 1][xCord] != 'b' && currentGrid[yCord - 1][xCord] != 'f' && posY - (sizeY / 2) < yCord * 35 + 2) {
        wallUp = true;
        println(1);
      }
      
      else if (currentGrid[yCord - 1][xCord - 1] != 'b' && currentGrid[yCord - 1][xCord - 1] != 'f' && posY - (sizeY / 2) < yCord * 35 + 2 &&
    ...
    if (keys['s'] == true) {
      ...
      if (currentGrid[yCord + 1][xCord] != 'b' && currentGrid[yCord + 1][xCord] != 'f' && posY + (sizeY / 2) > yCord * 35 + 34) {
        wallUp = true;
        println(1);
      }
      
      else if (currentGrid[yCord + 1][xCord - 1] != 'b' && currentGrid[yCord + 1][xCord - 1] != 'f' && posY + (sizeY / 2) > yCord * 35 + 34 &&
      posX < walls[yCord + 1][xCord - 1].x + 35 + sizeX / 2) {
        wallUp = true;
        println(2);
      }
