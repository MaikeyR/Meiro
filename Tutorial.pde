class Tutorial{
  ...
  void draw(){
    ...
    else fill (150); rect(170, 60, 40, 40);
    
    if (pattern == 1 || pattern == 4){
      fill(100);
      rect(60, 170, 40, 40);
    }
    else fill (150); rect(60, 170, 40, 40);
    
    if (pattern == 2 || pattern == 5){
      fill(100);
      rect(170, 280, 40, 40);
    }
    else fill (150); rect(170, 280, 40, 40);
    
    if (pattern == 0 || pattern == 5){
      fill(100);
      rect(280, 170, 40, 40);
    }
    else fill (150); rect(280, 170, 40, 40);
    ...
    textSize(25);
    fill(0);
    timer.time = timer.hour() +" : "+ timer.minute() +" : "+ timer.second() +"      + 1 sec";
